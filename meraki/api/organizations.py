 ...
 Each property defaults to 'default or inherit' when not provided.
    ...
    def getOrganizationDevicesStatuses(self, organizationId: str, total_pages=1, direction='next', **kwargs):
        ...
        **List the status of every Meraki device in the organization**
        ...
        query_params = ['perPage', 'startingAfter', 'endingBefore', 'networkIds', 'serials', 'statuses', 'productTypes', 'models', 'tags', 'tagsFilterType', 'configurationUpdatedAfter', ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}
    ...
    def getOrganizationNetworkObjectGroups(self, organizationId: str):
        """
        **Lists Network Object Groups belonging to the organization.**
        ...
        metadata = {
            'tags': ['organizations', 'configure', 'networkObjectGroups'],
            'operation': 'getOrganizationNetworkObjectGroups'
        }
        resource = f'/organizations/{organizationId}/networkObjectGroups'

        return self._session.get(metadata, resource)
        


    def createOrganizationNetworkObjectGroup(self, organizationId: str, name: str, **kwargs):
        """
        **Creates a new Network Object Group.**
        https://developer.cisco.com/meraki/api-v1/#!create-organization-network-object-group
        ...
        - networkObjectIds (array): A list of Network Object ID's that this NetworkObjectGroup should be associated to (note: these ID's will replace the existing associated Network Objects)
        """
        ...
        metadata = {
            'tags': ['organizations', 'configure', 'networkObjectGroups'],
            'operation': 'createOrganizationNetworkObjectGroup'
        }
        resource = f'/organizations/{organizationId}/networkObjectGroups'

        body_params = ['name', 'networkObjectIds', ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
    ...
    def getOrganizationNetworkObjectGroup(self, organizationId: str, networkObjectGroupId: str):
        """
        **Shows details of a Network Object Group.**
        https://developer.cisco.com/meraki/api-v1/#!get-organization-network-object-group

        - organizationId (string): (required)
        - networkObjectGroupId (string): (required)
        """

        metadata = {
            'tags': ['organizations', 'configure', 'networkObjectGroups'],
            'operation': 'getOrganizationNetworkObjectGroup'
        }
        resource = f'/organizations/{organizationId}/networkObjectGroups/{networkObjectGroupId}'

        return self._session.get(metadata, resource)
        


    def updateOrganizationNetworkObjectGroup(self, organizationId: str, networkObjectGroupId: str, **kwargs):
        """
        **Updates a Network Object Group.**
        https://developer.cisco.com/meraki/api-v1/#!update-organization-network-object-group
        ...
        metadata = {
            'tags': ['organizations', 'configure', 'networkObjectGroups'],
            'operation': 'updateOrganizationNetworkObjectGroup'
        }
        resource = f'/organizations/{organizationId}/networkObjectGroups/{networkObjectGroupId}'
    ...
    def deleteOrganizationNetworkObjectGroup(self, organizationId: str, networkObjectGroupId: str):
        """
        **Deletes a Network Object Group.**
        https://developer.cisco.com/meraki/api-v1/#!delete-organization-network-object-group
        ...
        metadata = {
            'tags': ['organizations', 'configure', 'networkObjectGroups'],
            'operation': 'deleteOrganizationNetworkObjectGroup'
        }
        resource = f'/organizations/{organizationId}/networkObjectGroups/{networkObjectGroupId}'
    ...
    def getOrganizationNetworkObjects(self, organizationId: str):
        """
        **Lists Network Objects belonging to the organization.**
        https://developer.cisco.com/meraki/api-v1/#!get-organization-network-objects

        - organizationId (string): (required)
        """

        metadata = {
            'tags': ['organizations', 'configure', 'networkObjects'],
            'operation': 'getOrganizationNetworkObjects'
        }
        resource = f'/organizations/{organizationId}/networkObjects'

        return self._session.get(metadata, resource)
        


    def createOrganizationNetworkObject(self, organizationId: str, name: str, type: str, value: str, **kwargs):
        """
        **Creates a new Network Object.**
        https://developer.cisco.com/meraki/api-v1/#!create-organization-network-object

        - organizationId (string): (required)
        - name (string): Name of a network object, unique within the organization (alphanumeric, space, dash, or underscore characters only)
        - type (string): Type of a network object (one of: "ipv4Cidr", "fqdn")
        - value (string): Value of a network object (e.g. "1.2.3.4", "10.11.12.1/24")
        - networkObjectGroupIds (array): The IDs of network object groups the network object belongs to
        """
        ...
        metadata = {
            'tags': ['organizations', 'configure', 'networkObjects'],
            'operation': 'createOrganizationNetworkObject'
        }
        resource = f'/organizations/{organizationId}/networkObjects'

        body_params = ['name', 'type', 'value', 'networkObjectGroupIds', ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
    ...
    def getOrganizationNetworkObject(self, organizationId: str, networkObjectId: str):
        """
        **Shows details of a Network Object.**
        https://developer.cisco.com/meraki/api-v1/#!get-organization-network-object

        - organizationId (string): (required)
        - networkObjectId (string): (required)
        """

        metadata = {
            'tags': ['organizations', 'configure', 'networkObjects'],
            'operation': 'getOrganizationNetworkObject'
        }
        resource = f'/organizations/{organizationId}/networkObjects/{networkObjectId}'

        return self._session.get(metadata, resource)
        


    def updateOrganizationNetworkObject(self, organizationId: str, networkObjectId: str, **kwargs):
        """
        **Updates a Network Object.**
        https://developer.cisco.com/meraki/api-v1/#!update-organization-network-object
        ...
        metadata = {
            'tags': ['organizations', 'configure', 'networkObjects'],
            'operation': 'updateOrganizationNetworkObject'
        }
        resource = f'/organizations/{organizationId}/networkObjects/{networkObjectId}'

        body_params = ['name', 'value', 'networkObjectGroupIds', ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
    ...
    def deleteOrganizationNetworkObject(self, organizationId: str, networkObjectId: str):
        """
        **Deletes a Network Object.**
        https://developer.cisco.com/meraki/api-v1/#!delete-organization-network-object
        ...
        metadata = {
            'tags': ['organizations', 'configure', 'networkObjects'],
            'operation': 'deleteOrganizationNetworkObject'
        }
        resource = f'/organizations/{organizationId}/networkObjects/{networkObjectId}'
    ...
    def createOrganizationPolicyObject(self, organizationId: str, name: str, category: str, type: str, **kwargs):
        ...
        **Creates a new Policy Object.**
        ...
        - type (string): Type of a policy object (one of: ipAndMask, cidr, adaptivePolicyIpv4Cidr, fqdn)
